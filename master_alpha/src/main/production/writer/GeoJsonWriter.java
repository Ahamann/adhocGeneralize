...
public class GeoJsonWriter {
	 ...
	 * @throws IOException
	 */
	public static void writeJsonSingle(Polygon jsonPolygon,int polygonID, String path, String name, String type) throws IOException{
	...
	public static String writeJsonString(Polygon[] jsonPolygons, String name, String type) throws IOException{

 ...
 */
requester.dataBaseRequest = function(mode, minx, miny, maxx, maxy,scale,maxTypify,fixElements,minArea,minDistance,speed,typmode,weight,union,simplify,  callback) {	 
	$.ajax({
		"url" : 'mainServlet',
		"type" : 'GET',
		"dataType" : 'json',

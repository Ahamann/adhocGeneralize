...
implements SpatialIndex, Serializable 
{
  ...
  private static final int DEFAULT_NODE_CAPACITY = 10;//10
  ...
  public boolean replace(Envelope searchBounds, Object itemReplace, Envelope boundsNew ,Object itemNew){
	  return super.replace( searchBounds,  itemReplace,  boundsNew , itemNew);
  }
  ...
  private Object[] nearestNeighbour(BoundablePair initBndPair, double maxDistance) 
  {
    ...
    while (! priQ.isEmpty() && distanceLowerBound > 0.0) {
      ...
      if (bndPair.isLeaves()) {
        ...
        if(currentDistance > 0)                                  //THIS IS FUCKING IMPORTANT
